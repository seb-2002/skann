    ...
    dramaturgy: {
      ...
      projects: {
        ...
        funfunfunfunfun: {
          ...
          description:
            "Lion Lion w/ François Bouvier //dramaturgical guidance for one of the episodes in a larger performative event",
          href: "https://montrealcompletementcirque.com/en/program/shows/fun-fun-fun-fun-fun/",
        },
        uca: {
          title: "Une caresse animée",
          src: "/static/src/uca_img.png",
          description:
            "François Bouvier //livestreamed multi-media performance",
    ...
    performer: {
      ...
      projects: {
        ...
        nien_tzu: {
          ...
          description:
            "choreography - Nien Tzu Weng //performance- Nien Tzu Weng, Basile Herrmann Philippe, Sebastian Kann //sound design- Sebastian Kann //in the context of Danse Cité Espace Recherche",
    ...
    dramaturgy: {
      ...
      projects: {
        unstaging_tactility: {
          ...
          description:
            "choreography- Vera Tussing //dance- Vera Tussing + Esse Vanderbruggen //music- Anna Muchin //light- Caroline Mathieu //costume- Jivan van den Ende //special thanks to- JS Rafaelli// research phase",
    ...
    writing: {
      ...
      projects: {
        the_circus_dialogues: {
          ...
          description:
            "with Bauke Lievens, Quintijn Ketels, Vincent Focquet //2 years of research supported by KASK School of Arts Ghent //photo Jakob Rosseel",
