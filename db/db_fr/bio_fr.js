const bio_fr = {
  ...
  text: [
    ...
    },
    {
      ...
      p_2: "chorégraphe avec laquelle il travaille souvent en tant que dramaturge. Sebastian assiste à la création de deux œuvres signées Vera Tussing,",
      p_3: {
        anchor: "<<Mazing>>",
    ...
    },
    {
      ...
      p_10: "avec Bauke Lievens, Vincent Focquet, et",
      p_2: {
        anchor: "Quintijn Ketels.",
        href: "https://www.side-show.be/fr",
      },
      p_3: "Leur projet, qui a pour sujet le cirque comme processus de pensée, est soutenu par",
      p_6: {
        anchor: "KASK,",
        href: "https://schoolofartsgent.be/2021/?lang=en",
      },
      p_7: "l'École de beaux-arts de Gand.",
      p_8: {
    ...
    },
    {
      ...
      p_9: {
        anchor: "Sarah Manya.",
        href: "https://electriques.ca/filles/fr/artiste/manya_sa",
      },
    },
    {
      ...
      p_5: "et y travaille en tant que conseiller artistique.",
    },
